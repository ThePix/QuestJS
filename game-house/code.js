...
const walkthroughs = {
  ...
  b:[
    ...
    "x key",
    "get key",
    // Now we can go south, and smash a window. In fact, you can smash a window in many rooms, so take your pick. Grab a shard of the brokenm glass.
    "south",
    "smash window",
    "get shard",
    // Head into the drawing room. There are two ways in, you can also go south, and then east from there. Whichever you go in first will be the "small" way - you will be tiny, the room will be huge. When you go in other way, you will be normal size.
    "east",
    "northeast",
    "x cab",
    "x cracks",
    ...
    "west",
    "south",
    // Now when we go into the drawing room it will be normal sized, and we can move the cabinet
    "east",
    "x cab",
    "shift cab",
    "west",
    "north",
    // With the cabinet shifted, you can go into the drawing room when you are tiny, go though the hole, and grab the boots
    "east",
    "northeast",
    "x cab",
    "x cracks",
    ...
    "s",
    "southwest",
    // Drop the boots here, and pick them up when you are big and the boots will have changed size
    "drop boots",
    "west",
    "south",
    "east",
