...
'use strict'
import { util, settings, game } from './util'
// @DOC
// ##Output functions
//
...
io.menuFn
io.menuOptions
// A list of names for items currently util.display in the inventory panes
io.currentItemList = []
...
io.clickItemAction = function (itemName, action) {
  ...
  if (cmd === undefined) {
    ...
    io.io.msgInputText(action + ' ' + item.alias)
