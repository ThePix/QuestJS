...
// !!! an error hereabouts makes all the item actions display if a choice is displayed
// I guess the items are re-created in the inventories with the display on
// but do not get a chance to get turned off
