...
const RPG_NPC = function(female) {
  ...
  res.getVerbs = function() {
    return [lang.verbs.lookat, lang.verbs.talkto, lang.verbs.attack];
  };
...
const EQUIPPABLE = function() {
  ...
  res.getVerbs = function() {
    if (!this.isAtLoc(game.player.name)) {
      ...
      return [lang.verbs.drop, lang.verbs..unequip];
    }
    else {
      return [lang.verbs.drop, lang.verbs.equip];
    }
  };
  ...
  res.onCreation = function(o) {
    o.nameModifierFunctions.push(function(o, list) {
      if (o.equipped && o.isAtLoc(game.player.name)) list.push(lang.invEquippedModifier)
    })
  }
