...
tp.findSubject = function(arr, params) {
  ...
  if (params[arr[0]]) {
    ...
    if (subject === undefined) {
      errormsg("In text processor nv, could not find a subject with '" + arr[0] + "'. Check the console (F12) to see what params is.");
      console.log("params:");
      console.log(params);
      return false;
    }
    ...
    subject = w[arr[0]]
    if (subject === undefined) {
      errormsg("In text processor nv, could not find a subject called '" + arr[0] + "'.");
      console.log("params:");
      console.log(params);
      return false;
    }
