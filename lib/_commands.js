...
const commands = [
  ...
  new Cmd('Take', {
    npcCmd:true,
    rules:[cmdRules.isHereAlready, cmdRules.canManipulate],
    objects:[
  ...
  new Cmd('Smash', {
    npcCmd:true,
    rules:[cmdRules.canManipulate, cmdRules.isPresent],
    objects:[
      {scope:parser.isHeld, multiple:true},
    ],
  ...
  new Cmd('Turn', {
    npcCmd:true,
    rules:[cmdRules.canManipulate, cmdRules.isPresentOrContained],
    objects:[
      {scope:parser.isHere},
    ],
  ...
  new Cmd('SitOn', {
    npcCmd:true,
    cmdCategory:"Posture",
    rules:[cmdRules.canPosture, cmdRules.isHere],
    attName:"siton",
    objects:[
