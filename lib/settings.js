...
settings.inventories = [
  { name: 'Items Held', alt: 'itemsHeld', util.test: settings.isHeldNotWorn, getLoc: function () { return game.player.name } },
  { name: 'Items Worn', alt: 'itemsWorn', util.test: settings.isWorn, getLoc: function () { return game.player.name } },
  { name: 'Items Here', alt: 'itemsHere', util.test: settings.isHere, getLoc: function () { return game.player.loc } }
]
