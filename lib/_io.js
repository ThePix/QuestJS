...
function showDiag(title, text, submitButton) {
  ...
  askDiag({title:title, text:text, width:600}, null, submitButton)
}
...
function askDiag(title, fn, submitButton) {
  ...
  io.input(false, [], disableTextFunction, fn ? fn : function() { }, displayFunction)
...
io.writeExit = function(n) {
  html += '<td class="compass-button" title="' + lang.exit_list[n].name + '">'
