...
io.writeExit = function(n) {
  ...
  document.write(settings.symbolsForCompass ? io.displayIconsCompass(lang.exit_list[n].name, lang.exit_list[n].symbol) : lang.exit_list[n].abbrev);
...
io.displayIconsCompass = function(name, icon)
{
    let datatransform = "";
