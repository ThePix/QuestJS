...
const OPENABLE_DICTIONARY = {
  open:function(isMultiple, char) {
    ...
    else if (this.checkOpenClose && !this.checkOpenClose(true)) {
      return false
    }
    if (this.locked) {
  ...
  close:function(isMultiple, char) {
    ...
    else if (this.checkOpenClose && !this.checkOpenClose(false)) {
      return false
    }
    this.closed = true;
...
const CHARACTER = function() {
  const res = {
    ...
    moveChar:function(roomName, dir) {
      ...
      for (let el of this.onGoActionList) {
        w[el].onGoAction(this, room, dir)
      }
    },
