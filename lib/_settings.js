...
const settings = {
  ...
  saveLoadExcludedAtts:[
    "name", "pronouns", "verbFunctions", "nameModifierFunctions", "ensembleMembers", "gameState",
    "clonePrototype", "gameState", "afterEnterIf", "saveLoadExcludedAtts", "startTime", "askOptions",
    "tellOptions", "regex",
  ],
  ...
  writeScript:function(folder) {
    ...
    document.writeln('<link rel="shortcut icon" type="image/png" href="' + settings.favicon + '"/>')
