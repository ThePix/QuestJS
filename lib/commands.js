...
var commands = [
  ...
  new Cmd('Inv', {
    ...
    script:function() {
      ...
      msg("You are carrying " + formatList(listOfOjects, {article:"a", lastJoiner:" and ", modified:true, nothing:"nothing", loc:game.player.name}) + ".");
      return SUCCESS_NO_TURNSCRIPTS;
    },
  }),
  new Cmd('Map', {
  ...
  new Cmd('Talk to', {
    ...
    default:function(item) {
      msg("You chat to " + item.byname({article:"the"}) + " for a few moments, before releasing that " + pronounVerb(item, "'be") + " not about to reply");
      return false;
    },
  }),
