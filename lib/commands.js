...
const commands = [
  ...
  new Cmd('Eat', {
    ...
    objects:[
      {ignore:true},
      {scope:isHeld, multiple:true, attName:"ingest"},
    ],
    defmsg:CANNOT_EAT,
  }),
  new Cmd('Smash', {
  ...
  new Cmd('Switch off2', {
    ...
    objects:[
      {ignore:true},
      {scope:isHeld, multiple:true, attName:"switchon"},
    ],
  ...
  new Cmd('Switch off', {
    ...
    objects:[
      {ignore:true},
      {scope:isHeld, multiple:true, attName:"switchoff"},
    ],
    defmsg:CANNOT_SWITCH_OFF,
  }),
  ...
  new Cmd('Open', {
    ...
    objects:[
      {ignore:true},
      {scope:isPresent, multiple:true, attName:"open"},
    ],
    defmsg:CANNOT_OPEN,
  }),
  ...
  new Cmd('Close', {
    ...
    objects:[
      {ignore:true},
      {scope:isPresent, multiple:true, attName:"close"},
    ],
    defmsg:CANNOT_CLOSE,
  }),
  ...
  new Cmd('Lock', {
    ...
    objects:[
      {ignore:true},
      {scope:isPresent, multiple:true, attName:"lock"},
    ],
    defmsg:CANNOT_LOCK,
  }),
  ...
  new Cmd('Unlock', {
    ...
    objects:[
      {ignore:true},
      {scope:isPresent, multiple:true, attName:"unlock"},
    ],
  ...
  new Cmd('Eat', {
    ...
    objects:[
      {ignore:true},
      {scope:isPresent, attName:"ingest"},
    ],
    defmsg:CANNOT_EAT,
  }),
  new Cmd('Drink', {
  ...
  new Cmd('PushExit', {
    ...
    objects:[
      {text:true},
      {scope:isHere, attName:"shiftable"},
      {text:true},
    ]
  }),
