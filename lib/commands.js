...
const commands = [
  ...
  new Cmd('Transcript', {
    ...
    script:function() {
      ...
      metamsg("Everything gets saved to memory, and will be lost if you go to another web page or close your browser, but should be saved when you save your game.");
      return SUCCESS_NO_TURNSCRIPTS;
    },
  }),
