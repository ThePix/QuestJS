...
const handleTieTo = function(char, rope, obj2) {
  if (!rope.rope) return failedmsg("You cannot {rope.attachVerb} that to anything.", {rope:rope})
  if (!obj2.attachable) return failedmsg("That is not something you can {rope.attachVerb} the {nm:rope:the} to.", {rope:rope})
  ...
  if (rope.tiedTo1 && rope.tiedTo2) return failedmsg("It is already {rope.attachedVerb} to {nm:rope:the} and {nm:rope:the}.", {rope:w[rope.tiedTo1], obj2:w[rope.tiedTo2]})
...
const handleUntieFrom = function(char, rope, obj2) {
  if (rope !== w.rope) return failedmsg("You cannot {rope.attachVerb} - or {rope.detachVerb} - that to anything.", {rope:rope})
  if (obj2 === undefined) {
