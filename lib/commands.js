...
var commands = [
  ...
  new Cmd('Look out', {
    ...
    default:function(item, isMultiple, char) {
      msg(prefix(this, isMultiple) + CMD_CANNOT_LOOK_OUT(char, item));
      return false;
    },
  }),
  new Cmd('Look behind', {
    ...
    default:function(item, isMultiple, char) {
      msg(prefix(this, isMultiple) + CMD_NOTHING_THERE(char));
      return false;
    },
  }),
  new Cmd('Look under', {
  ...
  new Cmd('Smash', {
    ...
    default:function(item, isMultiple, char) {
      msg(prefix(item, isMultiple) + CMD_CANNOT_SMASH(char, item));
      return false;
    },
  }),
  new Cmd('TurnOn', {
