...
test.runTests = function() {
  ...
  test.assertCmd("e", ["A clean room.", "You can see a trapdoor, a camera, Kyle (holding a book, and wearing a straw boater), a big kitchen table and a garage door here.", "You can go north or west.", "A fresh smell here!"]);
