...
const zoneExit = function(char, dir) {
  //console.log("At " + char.positionX + "," + char.positionY + " and going " + dir + " (" + this.moveX + "," + this.moveY + ")")
  ...
  if (dir === 'in' || dir === 'up' || dir === 'down' || dir === 'out') {
...
const ZONE = function() {
  ...
  res.out = new Exit("", {use:zoneExit, moveX:0, moveY:0},)
  ...
  res.hasExit = function(dir, options) {
    ...
    // Check if this would cross a border
    const newX = game.player.positionX + this[dir].moveX
    const newY = game.player.positionY + this[dir].moveY
