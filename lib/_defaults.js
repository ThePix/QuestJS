...
const DEFAULT_OBJECT = {
  ...
  canSeeThrough:() => false,
  afterItemTakenFrom:NULL_FUNC,
  afterItemDroppedHere:NULL_FUNC,
  canTalkPlayer:() => false,
  ...
  moveToFrom:function(toLoc, fromLoc) {
    ...
    this.loc = toLoc; 
    w[fromLoc].afterItemTakenFrom(this);
    w[toLoc].afterItemDroppedHere(this);
    if (this.afterMove !== undefined) this.afterMove(toLoc, fromLoc)
  },
