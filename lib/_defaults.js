...
const DEFAULT_OBJECT = {
  ...
  moveToFrom:function(options, toLoc, fromLoc) {
    ...
    w[options.fromLoc].afterTakeOut(options.char, {item:this});
    w[options.toLoc].afterDropIn(options.char, {item:this});
  ...
  setAlias:function(alias, options = {}) {
    this.alias = alias
    this.listAlias = options.listAlias ? options.listAlias : alias
