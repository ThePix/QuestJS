...
map.update = function() {
  ...
  mapOtherLevels.push('<g stroke="' + settings.mapBorderColour + '" stroke-width="1" fill="' + settings.mapLocationColour + '" id="other-levels-layer" opacity="0.2" pointer-events="none">')
  ...
  mapLabels.push('<g  pointer-events="none" id="labels-layer" fill="' + settings.mapLabelColour + '" text-anchor="middle">')
