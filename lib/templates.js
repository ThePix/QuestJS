...
const PLAYER = function() {
  ...
  const res = {
    ...
    checkCannotSpeak:function(npc) { return false; },
    pause:function() { },  // so it is like an NPC
    canManipulate:function() { return true; },
    canMove:function() { return true; },
    canTalk:function() { return true; },
    canPosture:function() { return true; },
    canWearRemove:function() { return true; },
    canTakeDrop:function() { return true; },
    getOuterWearable:world.getOuterWearable,
  }
  return res;
};
