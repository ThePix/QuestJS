...
const saveLoad = {
  ...
  loadGame: function (filename) {
    ...
    if (s != null) {
      ...
      metaio.msg('Load failed: File not found')
    }
  },
  ...
  setLoadString: function (s) {
    ...
    io.errorio.msg("Unknown save type for object '" + name + "' (" + hash.saveType + ')')
  },
