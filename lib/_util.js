...
util.findSource = function(chr, fluid) {
...
util.defaultExitUse = function(char, dir, exit) {
  ...
  return this.simpleUse ? this.simpleUse(char, dir, exit) : util.defaultSimpleExitUse(char, exit)
}
