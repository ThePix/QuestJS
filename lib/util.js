...
util.listContents = function(contents) {
  return lang.contentsForData[this.contentsType].prefix + formatList(contents, {article:INDEFINITE, lastJoiner:lang.list_and, modified:true, nothing:lang.list_nothing, loc:this.name}) + lang.contentsForData[this.contentsType].suffix;
}
