...
function formatList(itemArray, options) {
  ...
  const l = itemArray.map(function(el) {
...
// How many seconds after January 01, 1970 00:00:00 UTC
// As I write this, it is 1549478173 second past time zero
const START_TIME = new Date('December 17, 1995 03:24:00');
const DATE_OPTIONS = {
  hour:"2-digit",
  minute:"2-digit",
  second:"2-digit",
...
function timeAsString() {
  ...
  const milliseconds = SECONDS_PER_TURN * game.turnCount * 1000 + START_TIME.getTime();
  ...
  console.log(time.toLocaleString('en-GB', DATE_OPTIONS));
}
