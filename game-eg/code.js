...
commands.unshift(new Cmd('EgKick', {
  ...
  default: function (item, isMultiple, char) {
    return io.failedmsg(util.prefix(this, isMultiple) + lang.pronounVerb(char, 'kick', true) + ' ' + this.pronouns.objective + ', but nothing happens.')
  }
}))
...
commands.unshift(new Cmd('EgCharge', {
  ...
  default: function (item, isMultiple, char) {
    return io.failedmsg(util.prefix(item, isMultiple) + lang.pronounVerb(item, "'be", true) + ' not something you can charge.')
  }
}))
...
commands.unshift(new Cmd('EgMove', {
  ...
  default: function (item, isMultiple, char) {
    return io.failedmsg(util.prefix(item, isMultiple) + lang.pronounVerb(item, "'be", true) + ' not something you can move.')
  }
}))
