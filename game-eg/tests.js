...
test.tests = function() {
  ...
  test.assertCmd("e", ["You head east.", "A clean room, a clock hanging on the wall. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west.", "A fresh smell here!"]);
  test.assertCmd("put 2 bricks on to the table", "Done.");
  test.assertCmd("inv", "You are carrying five bricks and a knife.");
  test.assertCmd("look", ["A clean room, a clock hanging on the wall. There is a sink in the corner.", "You can see a big kitchen table (with two bricks and a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west."]);
  test.assertCmd("get the bricks", "You take two bricks.");
  test.assertCmd("get clock", "You take the clock.");
  test.assertCmd("look", ["A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a garage door and a trapdoor here.", "You can go north or west."]);
  test.assertCmd("drop clock", "You drop the clock.");
  test.assertCmd("look", ["A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a clock, a garage door and a trapdoor here.", "You can go north or west."]);
  ...
  test.assertCmd("e", ["You head east.", "A clean room. There is a sink in the corner.", "You can see a big kitchen table (with a jug on it), a camera, a clock, a garage door, Kyle (wearing a straw boater) and a trapdoor here.", "You can go north or west."]);
  ...
  test.assertCmd("s", ["A clean room. There is a sink in the corner.", /You can see/, "You can go down, north or west."]);
