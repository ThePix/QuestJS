...
hint.data = [
  ...
  { name:'wearHat', hint:'Put the hat on (WEAR HAT).', tutorial:"You will be picking up things a lot in text adventures. You should see the hat listed as held in the panel to the left now. Some games have limits on how much can be held, so be might only be able to pick up eight items, or whatever.|It is always worthwhile examining an object as it might give you a clue about what it is for. You can examine the hat by typing EXAMINE HAT, LOOK AT HAT or just X HAT. Or click on it in the panel, and select \"Examine\" from the menu.|Most commands in a text adventure will be of the form &lt;verb&gt; &lt;verb&gt;.|Hats can be worn, so let's put it on! You can type WEAR HAT or DON HAT or PUT HAT ON or PUT ON HAT as you prefer."},
