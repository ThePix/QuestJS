...
hint.data = [
  ...
  { name:'neToGarden', hint:'Type NORTHEAST to go into the garden.', tutorial:"Great, we can move around!|From here we can go back south to the lounge. Generally when you enter a room from one direction you will be able to go back that way, but not always.|As well as going north, south, east and west, you may be able to go along the diagonals, and also up and down, and in and out. This room has a basement you can go DOWN to and a larder you can go IN. Try moving with the compass rose; note how the buttons change depending on the available exits.|The tutorial continues in the garden to the northeast (type NORTHEAST or just NE)."},
  { name:'getHat', hint:'Pick up the hat (GET HAT), and put it on (WEAR HAT).', tutorial:'Let\'s interact with something!|There is a hat here. You know that because the description tells you, and also it is listed in the panel at the left. To get the hat, type GET HAT or TAKE HAT.|By the way, in most games you can use the up and down arrows to scroll through previous commands; this is especially useful if you spelled something wrong!'},
  { name:'wearHat', hint:'Put the hat on (WEAR HAT).', tutorial:"You will be picking up things a lot in text adventures. You should see the hat listed as held in the panel to the left now. Some games have limits on how much can be held, so we might only be able to pick up eight items, or whatever.|It is always worthwhile examining an object as it might give you a clue about what it is for. You can examine the hat by typing EXAMINE HAT, LOOK AT HAT or just X HAT. Or click on it in the panel, and select \"Examine\" from the menu.|Most commands in a text adventure will be of the form &lt;verb&gt; &lt;noun&gt;.|Hats can be worn, so let's put it on! You can type WEAR HAT or DON HAT or PUT HAT ON or PUT ON HAT as you prefer."},
